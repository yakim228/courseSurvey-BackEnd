...
public interface SurveyEntityRepository extends BaseEntityRepository<Survey>  {
    ...
    List<Survey> findbyCategoryAndCourse(@Param("CategoryID") Integer id_cat_survey , @Param("CourseID") Integer id_course);
    ...
    List<Survey> pendingSurvey(@Param("UserID") Integer id_user);
