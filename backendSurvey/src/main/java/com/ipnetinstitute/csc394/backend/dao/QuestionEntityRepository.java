...
public interface QuestionEntityRepository extends BaseEntityRepository<Question> {
    ...
    List<Question> findAllQuestionbyCategory(@Param("CategoryID") Integer id);
    ...
    List<Question>  pendingSurveyQuestions(@Param("surveyID") Integer id_survey, @Param("userID") Integer id_user);
